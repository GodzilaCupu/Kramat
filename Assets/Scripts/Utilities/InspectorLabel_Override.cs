...
using UnityEditor;
#endif
public class InspectorLabel_Override : PropertyAttribute
{
    public string label;
    public InspectorLabel_Override(string label)
    {
        this.label = label;
    }

#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(InspectorLabel_Override))]
    public class ThisPropertyDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            try
            {
                var propertyAttribute = this.attribute as InspectorLabel_Override;
                ...
                else
                {
                    Debug.LogWarningFormat(
                        ...
                        typeof(InspectorLabel_Override).Name,
